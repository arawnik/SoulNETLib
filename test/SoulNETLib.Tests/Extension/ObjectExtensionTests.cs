...
public class ObjectExtensionTests
{
    ...
    [InlineData("comment")]
    [InlineData("dateTime")]
    public void TypeHasProperty_WrongCaseExistingPropertiesSensitive_ReturnFalse(
        string propertyName
    )
    {
        // Arrange
    ...
    [InlineData("comment")]
    [InlineData("dateTime")]
    public void HasProperty_ClassWrongCaseExistingPropertiesSensitive_ReturnFalse(
        string propertyName
    )
    {
        // Arrange
    ...
    public void HasProperty_ObjectExistingPropertiesInsensitive_ReturnTrue(string propertyName)
    {
        ...
        var testDynamic = new
        {
            id = SampleNumbers.int1,
            name = SampleStrings.str1,
            DateTime = DateTime.UtcNow,
            Comment = SampleStrings.str2,
            test = SampleStrings.str3,
        };
    ...
    public void CopyPropertyValuesFrom_FieldsAreFound_ApplyChanges()
    {
        ...
        var testObj = new
        {
            ...
            DateTime = now,
            Comment = SampleStrings.str2,
            Hidden = SampleStrings.str3,
            Semi = SampleStrings.str4,
        };
        var testClass = new SampleObject(
            SampleNumbers.int2,
            SampleStrings.str4,
            DateTime.Today,
            SampleStrings.str5,
    ...
    public void CopyPropertyValuesFrom_FieldsNotFound_DiscardChanges()
    {
        ...
        var testObj = new
        {
            ID = SampleNumbers.int2,
            name = SampleStrings.str1,
            dateTime = now,
            comment = SampleStrings.str2,
            test = SampleStrings.str3,
            Trouble = SampleNumbers.int1,
        };
        var testClass = new SampleObject(
            SampleNumbers.int1,
            SampleStrings.str4,
