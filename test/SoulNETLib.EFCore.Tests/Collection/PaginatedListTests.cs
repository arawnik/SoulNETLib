...
public class PaginatedListTests
{
    ...
    public void PaginatedList_InitializedList_ReturnJsonList()
    {
        ...
        // Assert
        Assert.Equal(
            """[{"Id":1,"Name":"name1","Comment":"comment1","DateTime":"0001-01-01T00:00:00"},{"Id":2,"Name":"name2","Comment":"comment2","DateTime":"0001-01-01T00:00:00"},{"Id":3,"Name":"name3","Comment":"comment3","DateTime":"0001-01-01T00:00:00"},{"Id":4,"Name":"name4","Comment":"comment4","DateTime":"0001-01-01T00:00:00"},{"Id":5,"Name":"name5","Comment":"comment5","DateTime":"0001-01-01T00:00:00"}]""",
            jsonString
        );
    }
    ...
    public void PaginatedResult_InitializedList_ReturnJsonResult()
    {
        ...
        var list = new PaginatedResult<SampleObject>(
            new PaginatedList<SampleObject>(items, 123123, 2, 5)
        );
        ...
        // Assert
        Assert.Equal(
            "{\"page\":2,\"size\":5,\"pages\":24625,\"rows\":123123,\"items\":[{\"Id\":1,\"Name\":\"name1\",\"Comment\":\"comment1\",\"DateTime\":\"0001-01-01T00:00:00\"},{\"Id\":2,\"Name\":\"name2\",\"Comment\":\"comment2\",\"DateTime\":\"0001-01-01T00:00:00\"},{\"Id\":3,\"Name\":\"name3\",\"Comment\":\"comment3\",\"DateTime\":\"0001-01-01T00:00:00\"},{\"Id\":4,\"Name\":\"name4\",\"Comment\":\"comment4\",\"DateTime\":\"0001-01-01T00:00:00\"},{\"Id\":5,\"Name\":\"name5\",\"Comment\":\"comment5\",\"DateTime\":\"0001-01-01T00:00:00\"}]}",
            jsonString
        );
    }
